...
def main():
    # Genesis block and parameters from configuration
    genesis_hash = "C98C980927EAAB552002EAD60CE34CAF166A6DAF9945FD2059B5B438AF113766"
    height = 1  # First block after genesis
    ...
    print(f"Previous Block: {genesis_hash}")
    print(f"Merkle Root: {merkle_root}")
