...
typedef struct {
    ...
    uint8_t *expand_mat;    // Single block of size TENS_HIDDEN * TENS_IN_SIZE
    uint8_t *middle_mats;   // Single block of size TENS_ROUNDS * TENS_HIDDEN * TENS_HIDDEN
    uint8_t *compress_mat;  // Single block of size TENS_IN_SIZE * TENS_HIDDEN
