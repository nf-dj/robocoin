...
TEST_DIFFICULTY = 24
EXPECTED_NONCE = "00000000000000000000000000000000000000000000000000000000004eddeb"  # MSB format
EXPECTED_HASH = "000000afff99dbb90dfbf8f8fe5efe0b8e824865285223bb0854b2617675db31"   # MSB format
        ...
        try:
            ...
            while not self.should_stop:
                ...
                for i in range(self.batch_size):
                    hash_result = bytes(out_batch_cpu[i].tolist())
                    nonce_bytes = bytes(nonce_batch_cpu[i].tolist())
                    zeros = count_leading_zero_bits(hash_result[::-1])  # Count zeros in MSB order
